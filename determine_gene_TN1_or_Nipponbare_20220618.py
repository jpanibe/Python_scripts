...
#word_to_use_Nip_gene = r'Nip_gene_\d+$'
#word_to_use_TN1_gene = r'TN1_gene_\d+$'
...
n_Nip_gene1 = list(filter(lambda x: re.match(word_to_use_Nip_gene, x), merged_TNG67_in_NipandTN1_gene1))
filtered_TNG67_in_Nip_gene2 = list(filter(lambda x: re.match(word_to_use_Nip_gene, x), merged_TNG67_in_NipandTN1_gene2))
filtered_TNG67_in_Nip_qcov = list(filter(lambda x: re.match(word_to_use_Nip_gene, x), merged_TNG67_in_NipandTN1_gene2))
filtered_TNG67_in_Nip_qaln = list(filter(lambda x: re.match(word_to_use_Nip_gene, x), merged_TNG67_in_NipandTN1_gene2))filtered_TNG67_in_NipandTN1_qaln"""
