...
with open('TNG67_cds_sequence.fasta_to_TN1_and_IRGSP_cds.fasta_1e-3.txt_col_1.txt', 'r') as col_1_file:
...
with open('TNG67_cds_sequence.fasta_to_TN1_and_IRGSP_cds.fasta_1e-3.txt_col_3.txt', 'r') as col_3_file:
...
with open('TNG67_cds_sequence.fasta_to_TN1_and_IRGSP_cds.fasta_1e-3.txt_col_14.txt', 'r') as col_14_file:
...
with open('TNG67_cds_sequence.fasta_to_TN1_and_IRGSP_cds.fasta_1e-3.txt_col_15.txt', 'r') as col_15_file:
