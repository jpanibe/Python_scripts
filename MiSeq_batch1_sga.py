...
files_pe=['SG_DE51_351bp_CGATGT_L001_trimmomatic_minlen75','LGC-IS01_604bp_GATCAG_L001_trimmomatic_minlen150']
...
while i<len(files_pe):
	...
	os.system('sga index -t 16 --no-reverse %s.fastq' % files_pe[i])
