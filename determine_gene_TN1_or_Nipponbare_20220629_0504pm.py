...
"""
print "\n\n"
print "number of TNG67 genes assigned to Nipponbare: %d" % len(final_filtered_TNG67_in_Nip_gene2)
print "number of TNG67 genes assigned to TN1: %d" % len(final_filtered_TNG67_in_TN1_gene2)
...
uniquememberlist_Nipponbare_gene1=[]
